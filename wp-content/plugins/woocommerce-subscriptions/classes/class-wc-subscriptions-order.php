...
<div id="recurring_order_totals"<?php if ( ! $contains_subscription ) echo $display_none; ?>>
	...
	<div class="totals_group">
		...
		<div style="padding-top: 4px; font-style: italic; margin: 2px 0 10px;"><?php echo ( $manual_renewal || empty( $order->recurring_payment_method_title ) ) ? __( 'Manual', 'woocommerce-subscriptions' ) : $order->recurring_payment_method_title; ?></div>
	</div>
<?php
	}
