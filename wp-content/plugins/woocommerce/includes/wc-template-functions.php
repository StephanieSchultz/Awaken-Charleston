...
if ( ! function_exists('woocommerce_adminfee_input') ) {

    /*Output the checkbox to add a 3% admin fee to the product*/

    function woocommerce_adminfee_input($price){

        wc_get_template('global/adminfee-input.php', $price );
       $rate = 1.03;
        return ($price * $rate);
    }
}
